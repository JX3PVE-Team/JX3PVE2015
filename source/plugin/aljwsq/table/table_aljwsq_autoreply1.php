...
class table_aljwsq_autoreply extends discuz_table {

    public function __construct() {

        $this->_table = 'aljwsq_autoreply';
        $this->_pk = 'id';
    ...
    public function fetch_all_by_upid($upid, $msgtype, $id) {
        return DB::fetch_all('select * from %t where upid=%d and msgtype=%s and id!=%d and and status=1 order by displayorder,id asc', array($this->_table, $upid, $msgtype, $id));
    }
