...
if (empty($_GET['op'])) {
		...
		<head>
			...
			<style type="text/css">
				...
				*:lang(zh) a.cs{height:12px}
				...
				.fRd1 .cb{background-color:#ff0000}
				.fRd2 .cb{background-color:#0000ff}
				.fRd3 .cb{background-color:#ff00cc}
				.fRd4 .cb{background-color:#ff78c1}
				.fRd5 .cb{background-color:#d44fff}
				.fRd6 .cb{background-color:#e59efd}
				.fRd7 .cb{background-color:#b99efd}
				.fRd8 .cb{background-color:#9ec6fd}
				.fRd9 .cb{background-color:#04b9e6}
				.fRd10 .cb{background-color:#07aba1}
				.fRd11 .cb{background-color:#07ab22}
				.fRd12 .cb{background-color:#6bab07}
				.fRd13 .cb{background-color:#fea904}
				.fRd14 .cb{background-color:#999999}
				.fRd15 .cb{background-color:#cccccc}
				.fRd16 .cb{background-color:#FFFfff;border:1px solid #CCC}
				...
				.icohr{background:url("http://static.jx3pve.com/cdn/img/dz/editor/hr.gif") !important;}
				.icogss{background:url("http://static.jx3pve.com/cdn/img/dz/editor/gss.gif") !important;}
									...
									<td height="31" style="padding-left:3px">
										...
										<div class="toobar" id="dvToolbar">
											<div class="icons tble">
												...
												<a href="javascript:;" class="icogss" style="display:none" onClick="removestyle(event);return false;" title="清除文字格式"></a>
	...
	<?php } ?>
												...
												<a href="javascript:;" class="icohr" onClick="addvfhr();return false;" title="插入水平线"></a>
												<?php if ($allowhtml) { ?>
							...
							<div id="dvForeColor" class="eMenu" style="display:none;top:35px;left:26px;width:90px;">
								<a href="javascript:;" onClick="format(gSetColorType,'#ff0000');return false;" class="n cs fRd1"><b class="cb"></b><span>红色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#0000ff');return false;" class="n cs fRd2"><b class="cb"></b><span>蓝色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#ff00cc');return false;" class="n cs fRd3"><b class="cb"></b><span>玫瑰</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#ff78c1');return false;" class="n cs fRd4"><b class="cb"></b><span>粉色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#d44fff');return false;" class="n cs fRd5"><b class="cb"></b><span>紫色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#e59efd');return false;" class="n cs fRd6"><b class="cb"></b><span>浅紫</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#b99efd');return false;" class="n cs fRd7"><b class="cb"></b><span>蓝紫</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#9ec6fd');return false;" class="n cs fRd8"><b class="cb"></b><span>蔚蓝</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#04b9e6');return false;" class="n cs fRd9"><b class="cb"></b><span>天蓝</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#07aba1');return false;" class="n cs fRd10"><b class="cb"></b><span>水蓝</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#07ab22');return false;" class="n cs fRd11"><b class="cb"></b><span>绿色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#6bab07');return false;" class="n cs fRd12"><b class="cb"></b><span>草绿</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#fea904');return false;" class="n cs fRd13"><b class="cb"></b><span>橙色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#999999');return false;" class="n cs fRd14"><b class="cb"></b><span>灰色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#cccccc');return false;" class="n cs fRd15"><b class="cb"></b><span>银色</span></a>
								<a href="javascript:;" onClick="format(gSetColorType,'#FFFFFF');return false;" class="n cs fRd16"><b class="cb"></b><span>白色</span></a>
							</div>
