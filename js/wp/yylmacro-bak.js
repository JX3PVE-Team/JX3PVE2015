									...
									success:function(data){
										...
										if(_IE === undefined){
											$("#yyl-content-title").zclip({
												path: "http://static.yylmacro.com/wp/js/ZeroClipboard.swf",
												copy:function(){
